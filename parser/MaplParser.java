/* Generated By:JavaCC: Do not edit this line. MaplParser.java */
  ...
  final public Type nt_SimpleType() throws ParseException {
  Token t;
  Type type;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
      t = jj_consume_token(INT);
      type = new TypeInt(); {if (true) return type;}
      break;
    case BOOLEAN:
      t = jj_consume_token(BOOLEAN);
      type = new TypeBoolean(); {if (true) return type;}
      break;
    default:
      jj_la1[6] = jj_gen;
      jj_consume_token(-1);
    ...
    default:
      ...
      {if (true) return tag(new StmArrayAssign(e, e1, e2), t);}
        ...
        case IF:
          ...
          sf = nt_Statement();
      {if (true) return tag(new StmIf(e, st, sf), t1);}
          break;
        case WHILE:
          ...
          jj_consume_token(DO);
          s = nt_Statement();
      {if (true) return tag(new StmWhile(e, s), t1);}
          break;
        case OUTPUT:
  ...
  final public StmBlock nt_For() throws ParseException {
  Stm s, forBody;
  Exp condition;
  List<Stm> outerBlockStms = new LinkedList<Stm>();
  List<Stm> whileBodyStms = new LinkedList<Stm>();
    ...
    jj_consume_token(RPAREN);
    forBody = nt_Statement();
        whileBodyStms.add(0, forBody);
        StmWhile w = new StmWhile(condition, new StmBlock(whileBodyStms));
        outerBlockStms.add(w);
        {if (true) return new StmBlock(outerBlockStms);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1800,0x1800,0x8009c300,0x8009c300,0x0,0x2000,0x2000,0x8009c300,0x80000,0x8001c300,0x7f820000,0x8001c300,0x3f800000,0x8001c300,0x0,0x8001c300,0x8009c300,0x8009c300,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0xad98,0xad98,0x2,0x4,0x4,0xad98,0x8,0xad90,0x0,0x8010,0x0,0x8010,0x2,0x8010,0xad98,0xad98,};
   }
